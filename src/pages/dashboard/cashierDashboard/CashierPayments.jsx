      ...
      <div className="bg-gradient-to-r from-[#0F172A] via-[#1E293B] to-[#0F172A] p-10 rounded-[3rem] shadow-2xl relative overflow-hidden border border-slate-200 mb-8">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between md:items-center gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl md:text-5xl font-normal leading-tight text-white" style={{ fontFamily: "DM Serif Display, serif" }}>Revenue Stream</h1>
              <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] mt-2">Financial Boutique Performance</p>
            </div>
          </div>
