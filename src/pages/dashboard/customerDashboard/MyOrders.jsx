                        ...
                        <div className="flex items-center justify-between md:justify-end gap-6 w-full md:w-auto border-t md:border-t-0 border-slate-100 pt-4 md:pt-0">
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              className="flex items-center gap-2 px-4 py-2 bg-slate-900 border border-white/5 text-slate-300 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-[#D4AF37] hover:text-[#0F172A] transition-all shadow-sm hover:shadow-lg cursor-pointer"
                            >
                              Print Receipt
                            </button>
                            <button 
                              onClick={() => generateInvoicePDF(order, settings)}
                              className="flex items-center gap-2 px-4 py-2 bg-slate-100 text-[#0F172A] hover:bg-[#D4AF37] border border-transparent rounded-xl text-[10px] font-black uppercase tracking-widest transition-all cursor-pointer shadow-sm hover:shadow-lg"
                            >
                              Download PDF
                            </button>
                          </div>
